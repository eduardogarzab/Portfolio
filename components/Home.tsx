	...
	return (
		<section className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-52px)] px-6 relative">
			...
			<motion.a
				href="/resume.pdf"
				download
				className="mt-6 flex items-center bg-blue-500 hover:bg-blue-600 text-white font-bold px-4 py-2 rounded-xl shadow-md transition transform hover:scale-105 will-change-transform"
				initial={{ opacity: 0, y: 10 }}
				animate={{ opacity: 1, y: 0 }}
